...
function showRedirectMessage() {
    ...
    if (modalBody) {
        modalBody.innerHTML = `
            ...
            <p>
                <strong>Redirecionando para o Portal...</strong><br>
...
function redirectTo() {
    try {
        ...
        console.log('Redirecionando para:', CONFIG.ACCOUNT_URL);
        
        // Abrir em nova aba para melhor experiência do usuário
        window.open(CONFIG.ACCOUNT_URL, '_blank', 'noopener,noreferrer');
    ...
    message.innerHTML = `
        <div class="notification-content">
            ...
            <div class="notification-text">
                ...
                <p>A página foi aberta em uma nova aba.</p>
            </div>
        </div>
    `;
...
function showErrorMessage() {
    alert('Erro ao redirecionar. Por favor, acesse manualmente: ' + CONFIG.ACCOUNT_URL);
    closeModal();
}
...
function debugInfo() {
    ...
    console.log('- Account URL:', CONFIG.ACCOUNT_URL);
    console.log('- Support URL:', CONFIG.SUPPORT_URL);
